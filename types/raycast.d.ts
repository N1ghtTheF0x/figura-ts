...
declare interface FiguraRaycast
{
    ...
    block(startpos: FiguraVec3,endpos: FiguraVec3,blockCastType: BlockRayCastType,fluidCastType: FluidRaycastType): LuaMultiReturn<[LuaTable,FiguraVec3,string]>
    block(startX: number,startY: number,startZ: number,endpos: FiguraVec3,blockCastType: BlockRayCastType,fluidCastType: FluidRaycastType): LuaMultiReturn<[LuaTable,FiguraVec3,string]>
    block(startpos: FiguraVec3,endX: number,endY: number,endZ: number,blockCastType: BlockRayCastType,fluidCastType: FluidRaycastType): LuaMultiReturn<[LuaTable,FiguraVec3,string]>
    block(startX: number,startY: number,startZ: number,endX: number,endY: number,endZ: number,blockCastType: BlockRayCastType,fluidCastType: FluidRaycastType): LuaMultiReturn<[LuaTable,FiguraVec3,string]>

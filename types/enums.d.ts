...
// KeyIDs
declare type FiguraKeyID = `figura.config.${"action_wheel_button" | "popup_button" | "reload_button" | "panic_button" | "wardrobe_button"}`
declare type KeyID = Minecraft.KeyID | FiguraKeyID
// LoopModes
